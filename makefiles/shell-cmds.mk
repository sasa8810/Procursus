...
ifneq (,$(findstring simulator,$(MEMO_TARGET)))
SIMULATOR_W_LDFLAGS := -lresolv
endif
...
shell-cmds: shell-cmds-setup openpam
	...
	for bin in killall renice script time which getopt what jot apply lastcomm systime shlock systime whereis; do \
		echo $$bin; \
	...
	$(CC) $(CFLAGS) $(LDFLAGS) -o $(BUILD_STAGE)/shell-cmds/$(MEMO_PREFIX)$(MEMO_SUB_PREFIX)/bin/w w/*.c -D'__FBSDID(x)=' -DHAVE_UTMPX=1 -save-temps $(SIMULATOR_W_LDFLAGS); \
