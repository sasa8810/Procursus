...
SHARED-MIME-INFO_VERSION := 2.1
DEB_SHARED-MIME-INFO_V   ?= $(SHARED-MIME-INFO_VERSION)

shared-mime-info-setup: setup
	wget -q -nc -P $(BUILD_SOURCE) https://gitlab.freedesktop.org/xdg/shared-mime-info/-/archive/$(SHARED-MIME-INFO_VERSION)/shared-mime-info-$(SHARED-MIME-INFO_VERSION).tar.gz
	$(call EXTRACT_TAR,shared-mime-info-$(SHARED-MIME-INFO_VERSION).tar.gz,shared-mime-info-$(SHARED-MIME-INFO_VERSION),shared-mime-info)
	...
	sed -i 's|@AAAAAAAAAAAAAAAAAA@|'$$(find $(BUILD_WORK)/shared-mime-info/po -name '*.mo')'|g' $(BUILD_WORK)/shared-mime-info/data/freedesktop_generate.sh
...
shared-mime-info-package: shared-mime-info-stage
	...
	$(call PACK,shared-mime-info,DEB_SHARED-MIME-INFO_V)
