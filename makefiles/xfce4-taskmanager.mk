...
XFCE4-TASKMANAGER_VERSION := 1.5.4
DEB_XFCE4-TASKMANAGER_V   ?= $(XFCE4-TASKMANAGER_VERSION)

xfce4-taskmanager-setup: setup
	wget -q -nc -P $(BUILD_SOURCE) https://archive.xfce.org/src/apps/xfce4-taskmanager/$(shell echo $(XFCE4-TASKMANAGER_VERSION) | cut -f-2 -d.//xfce4-taskmanager-$(XFCE4-TASKMANAGER_VERSION).tar.bz2
